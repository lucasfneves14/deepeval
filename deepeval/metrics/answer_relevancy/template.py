...
**
IMPORTANT: Please make sure to only return in JSON format, with the 'verdicts' key mapping to a list of JSON objects. And make sure to escape double quotes and single quotes in the json values.
Example input: 
