...
**
IMPORTANT: Please make sure to only return in JSON format, with the "opinions" key as a list of strings. No words or explanation is needed.  And make sure to escape double quotes and single quotes in the json values.
**
